...
# o re é um módulo que serve para fazer buscas em strings e manipular strings
...
# 6 - Substituindo uma palavra
text = "O dia está lindo"
new_text = re.sub(r'lindo', 'chuvoso', text)
print(new_text)

# o modulo regex serve para fazer buscas em strings